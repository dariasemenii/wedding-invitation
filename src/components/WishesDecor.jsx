  ...
  return (
    <div className="wishes-decor" aria-hidden="true">
      ...
      <svg className="wd-decor wd-decor--bottle-tl" viewBox="0 0 50 110" fill="none">
        ...
        <ellipse cx="25" cy="62" rx="12" ry="6" stroke="#e8a898" strokeWidth="1" opacity="0.07"/>
        <path d="M13 50 C13 44 37 44 37 50" stroke="#e8a898" strokeWidth="1" opacity="0.07"/>
        {/* label */}
      ...
      <svg className="wd-decor wd-decor--envelope-tr" viewBox="0 0 90 65" fill="none">
        ...
        <path d="M45 22 C45 22 38 17 38 13a5 5 0 0 1 7-1 5 5 0 0 1 7 1c0 4-7 9-7 9z" fill="#6d3020" opacity="0.2"/>
      </svg>
      ...
      <svg className="wd-decor wd-decor--spark-3" viewBox="0 0 24 24" fill="none">
        <path d="M12 2 L13.4 10.6 L22 12 L13.4 13.4 L12 22 L10.6 13.4 L2 12 L10.6 10.6 Z" fill="#8c4a32" opacity="0.08"/>
      </svg>

      {/* Rose petals */}
      <svg className="wd-decor wd-decor--petal-1" viewBox="0 0 30 52" fill="none">
        <ellipse cx="15" cy="26" rx="9" ry="22" fill="#e8a898" opacity="0.08" transform="rotate(25 15 26)"/>
      </svg>
      ...
      <svg className="wd-decor wd-decor--petal-3" viewBox="0 0 30 52" fill="none">
        <ellipse cx="15" cy="26" rx="7" ry="18" fill="#8c4a32" opacity="0.07" transform="rotate(10 15 26)"/>
      </svg>
